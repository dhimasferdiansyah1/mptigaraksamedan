...
import { getAllDetail } from "../../action";
              ...
              <div className="flex w-full flex-col gap-4 lg:basis-2/6">
                <div className="flex flex-col items-start gap-2 lg:basis-1/6">
                  <div className="flex items-center gap-2 px-2 font-bold">
                    ...
                    PurchaseOrder
                    <div
                      className={`mx-4 flex w-fit items-center rounded-full p-[2px] px-[10px] text-sm lg:w-auto ${detail?.status_po === "Berjalan" ? "bg-yellow-300/80 text-yellow-950 hover:bg-yellow-200 dark:bg-yellow-300/30 dark:text-yellow-100" : "bg-green-300 text-white hover:bg-green-200"}`}
                    >
                      {detail?.status_po}
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <Link
                      href={`/dashboard/main/detail/${detail?.id}/purchaseorder/${detail?.id}`}
                    >
                ...
                <div className="flex flex-col items-start gap-2 lg:basis-1/6">
                  ...
                  >
                    ...
                    />
                    <Link
                      href={`/dashboard/main/detail/${detail?.id}/deliverynote/${detail?.delivery_note?.id}`}
                    >
                ...
                <div className="flex flex-col items-start gap-2 lg:basis-1/6">
                  ...
                  >
                    ...
                    <Link
                      href={`/dashboard/main/detail/${detail?.id}/faktur/${detail?.faktur?.id}`}
                    >
                      <Button variant="secondary">
